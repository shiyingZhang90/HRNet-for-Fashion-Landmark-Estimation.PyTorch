...
def main(source_img_root='./data', target_img_root='./data', source_name='image_2', target_name='image_1',
    ...
    """
    calculate thres
    1. crop base area (new_mask)
    2. find logo area, using thres (warp_smaller)
    3. add feather operator on warp_smaller
    """
    ...
    thres = np.max(new_mask[:, :, 0] * logo_metric * (logo_metric < 1))
    print(thres)
