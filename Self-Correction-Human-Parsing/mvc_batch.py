...
def main():
    ...
    for subdir in subdirs[0]:
        ...
        PARSING_VIS_DIR=args.input + '/test_label_vis'
        os.makedirs(PARSING_VIS_DIR, exist_ok=True)
       ...
       # os.makedirs(CLOTHMASK_DIR, exist_ok=True)
        ...
        with torch.no_grad():
            for idx, batch in enumerate(dataloader):
                ...
                parsing_result_path = os.path.join(PARSING_VIS_DIR,img_name[:-4]+'.png')
                ...
                original_mask.save(parsing_result_path_vis)
